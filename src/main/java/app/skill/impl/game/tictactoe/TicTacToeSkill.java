...
public class TicTacToeSkill extends DefaultSkillImpl {
    ...
    public static String boardToString(int[][] board){
        return  "<pre>"
                + (board[0][0] == 0 ? " A " : board[0][0] == 1 ? " \uD83C\uDF0E" : " \uD83C\uDF15")
                + (board[0][1] == 0 ? " B " : board[0][1] == 1 ? " \uD83C\uDF0E" : " \uD83C\uDF15")
                + (board[0][2] == 0 ? " C " : board[0][2] == 1 ? " \uD83C\uDF0E" : " \uD83C\uDF15") + "\n"
                + (board[1][0] == 0 ? " D " : board[1][0] == 1 ? " \uD83C\uDF0E" : " \uD83C\uDF15")
                + (board[1][1] == 0 ? " E " : board[1][1] == 1 ? " \uD83C\uDF0E" : " \uD83C\uDF15")
                + (board[1][2] == 0 ? " F " : board[1][2] == 1 ? " \uD83C\uDF0E" : " \uD83C\uDF15") + "\n"
                + (board[2][0] == 0 ? " G " : board[2][0] == 1 ? " \uD83C\uDF0E" : " \uD83C\uDF15")
                + (board[2][1] == 0 ? " H " : board[2][1] == 1 ? " \uD83C\uDF0E" : " \uD83C\uDF15")
                + (board[2][2] == 0 ? " I " : board[2][2] == 1 ? " \uD83C\uDF0E" : " \uD83C\uDF15") + "\n" +
                "</pre>";
    }
